        ...
        <form action="{{ route('society.store') }}"  method="POST" enctype="multipart/form-data">
          <div class="field">
            ...
            <div class="half-field">
              <div class="label"><span>Established Date</span></div>
                 <div class="label-value">
                  <div class="input-box">
                      <input type="text" class="datepicker" name="established_date" placeholder="Select Date" autocomplete="off" required="required" id="inspection_date"/>
                  </div>
                </div>              
            </div>
          </div>
          ...
          <div class="field">            
            ...
            <div class="half-field">
              <div class="label"><span>Attach Document</span></div>
                 <div class="label-value">
                  <div class="input-box"> 
                      <input type="file" name="uploaded_document" value="" />
                  </div>
                </div>              
            </div>
          </div>
          <div class="field">
            <div class="half-field">
              ...
              <div class="label-value">
                <div class="select-box">
                  <textarea name="building_info"></textarea>
                </div>
              </div>
            </div>            
            <div class="half-field">
